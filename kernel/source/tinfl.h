/* tinfl.c v1.11 - public domain inflate with zlib header parsing/adler32 checking (inflate-only subset of miniz.c)
   ...
   This is a heavily stripped-out version made by fincs which only leaves tinfl_decompress() and splits the library
   into an actual header and an actual C source code file.
*/
#pragma once
#include <stdlib.h>
